...
<td>
		...
		<big><a href="#" onclick="editarHorarios('{$id}','{$dia}', '{$inicio}', '{$final}', '{$inicio_almoco}', '{$final_almoco}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
function editarHorarios(id, dia, inicio, final, inicio_almoco, final_almoco){
		$('#id_d').val(id);
		$('#dias').val(dia).change();
		$('#inicio').val(inicio);
		$('#final').val(final);
